...
### Sheet: ΚΙΝΗΣΕΙΣ (Κινήσεις με Διπλογραφική Μέθοδο)
...
### Sheet: ΣΥΝΑΛΛΑΣΟΜΕΝΟΙ (Συναλλασσόμενοι)
```
CUSTID | NAME | VAT
...
**Σημείωση**: Το σύστημα:
- Διαβάζει NAME και VAT από το client_db αν υπάρχει το AFM
- Δημιουργεί αυτόματα νέες εγγραφές για AFM που δεν υπάρχουν στο client_db
- Χρησιμοποιεί το counterpart_name ή Name_issuer από το invoice για νέους συναλλασσομένους
